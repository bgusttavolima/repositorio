...
const ViaCep = () => {
    ...
    const handleConcluir = () => {
        if (!cep || !selectedValue) {
            ...
            setCep("");       // Limpa o campo do CEP
            setNum("");       // Limpa o campo do Número
            setComp("");      // Limpa o campo do Complemento
            setDados({});     // Limpa os dados do CEP
            setNome("");
            setEmail("");
            setSelectedValue(null); // Limpa a seleção do Estado
        }
        showModal();
    }
    ...
    return (
            ...
            <PaperProvider>
                    ...
                    <TextInput
                        label='Nome'
                        value={nome}
                        onChangeText={setNome}   // Usa setNum para atualizar o estado
                        mode='outlined'
                        textColor='#0fa'
                        outlineColor='#fff'
                    ...
                    <TextInput
                        label='Email'
                        value={email}
                        onChangeText={setEmail}   // Usa setNum para atualizar o estado
                        mode='outlined'
                        textColor='#0fa'
                        outlineColor='#fff'
                        activeOutlineColor='#fff'
                    ...
                    <TextInput
                        label='Numero'
                        value={num}
                        onChangeText={setNum}   // Usa setNum para atualizar o estado
                        mode='outlined'
                        textColor='#0fa'
                        outlineColor='#fff'
                        activeOutlineColor='#fff'
                    ...
                    <TextInput
                        label='Complemento'
                        value={comp}
                        onChangeText={setComp}  // Usa setComp para atualizar o estado
                        mode='outlined'
                        textColor='#0fa'
                        outlineColor='#fff'
                        activeOutlineColor='#fff'
